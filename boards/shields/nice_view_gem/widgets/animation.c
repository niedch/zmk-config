...
const lv_img_dsc_t *anim_imgs[] = {
    &bongocatrest0, &bongocatcasual1, &bongocatcasual2, &bongocatfast1, &bongocatfast2, &bongo_resting,
    &bongo_casualright, &bongo_casualleft, &bongo_furiousup, &bongo_furiousdown, &bongo_inhale, &bongo_exhale,
};
